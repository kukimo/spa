...
spa.fake = (function() {
  ...
  peopleList = [
  	  ...
  	  { name : 'Pebbles', _id : 'id_03',
  	    css_map : { top: 100, left: 20,
  	      'background-color': 'rbg( 128, 192, 192)'
  	    }
  	  },
  	  { name : 'Wilma', _id : 'id_04',
  	    css_map : { top: 140, left: 20,
  	      'background-color': 'rbg( 192, 128, 128)'
  	    }
  	  }
  	];
  ...
  mockSio = (function() {
    ...
    emit_sio = function( msg_type, data ) {
      ...
      // 3秒後にuserupdateコールバックで「adduser」イベントに応答する
      ...
      // 2秒後に「updatechat」コールバックで「updatechat」イベントに応答する
      ...
      // サーバへの「updateavatar」メッセージとデータ送信をシミュレート
